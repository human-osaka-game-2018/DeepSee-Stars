...
void DirectX::InitVertex(CustomVertex initCustomVertex[4])
{
	for (int i = 0; i < 4; i++)
	{
		initCustomVertex[i].z = 1.0f;
		initCustomVertex[i].rhw = 1.0f;
		initCustomVertex[i].color = 0xFFFFFFFF;
		if (i == 0)
		{
			initCustomVertex[i].tu = 0.f;
			initCustomVertex[i].tv = 0.f;
		}
		if (i == 1)
		{
			initCustomVertex[i].tu = 1.f;
			initCustomVertex[i].tv = 0.f;
		}
		if (i == 2)
		{
			initCustomVertex[i].tu = 1.f;
			initCustomVertex[i].tv = 1.f;
		}
		if (i == 3)
		{
			initCustomVertex[i].tu = 0.f;
