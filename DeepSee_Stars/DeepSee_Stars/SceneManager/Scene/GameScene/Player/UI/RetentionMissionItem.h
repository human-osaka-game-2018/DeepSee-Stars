...
namespace deepseestars
{
	...
	public:
		...
		void Init()
		{
			for (auto& number : m_MissionItemUITextureKey)
			{
				int index = &number - m_MissionItemUITextureKey;

				m_rGameBaseMaker.CreateTex(m_MissionItemUITextureKey[index], m_MissionItemUITextureName[index]);
			}
		}
